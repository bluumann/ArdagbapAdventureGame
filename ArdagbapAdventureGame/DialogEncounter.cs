        ...
        public DialogEncounter(string eventName, Image eventImage, string eventType, int key) : base(eventName, eventImage, eventType)
        {
            ...
            switch (eventType)
            {
                ...
                case "Skill":
                    ...
                    {
                        case 0:
                            EventDescription += "Two guards stand before you. They say one of them always lie, the other always tells the truth. You remember and old tale of the mighty Garbazi, who when faced with this dilema, ripped the head of one of the guards and asked the other, is he dead?";
                            break;
                        case 1:
                            ...
                            break;
                        case 2:
                            EventDescription += "You see an old ghost. You scream and tell him to go away. It doesn't. It starts to ramble about some sort of old warrior and some higiene process call Dago-Bath. You don't understand anything, but the ghost tells you to use the force! What force? Maybe he means your might!";
                            break;
                        case 3:
                ...
                case "Strength":
                    switch (key)
                    {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            EventDescription += "You see a nearby tablet with an odd prophecy written on it. As you begin to read, your eyes swirl into a reddish form with pointy dots. You realize your blood is boiling with magic and you must contain the power before you're lost in a kaleidoscopic maze of infinte dreams.";
                            break;
                        default:
